...
// shksaini
// pa2
// Reads a file from the command line to search for specific words
...
public class Search{
	...
	//intializes the length of the String and int array
	...
	//Scans the file, puts the word in the String array
    ...
    //mergeSort 
    // takes two Arrays, along with two integers p and r 
    // p and r must be >= 0 && < the length of the Array, then 
    // gives the task to merge
    ...
    // merge 
    // takes two Arrays, along with two ints p and r 
    // that are given from mergeSort, then
    ...
    // binarySearch 
    // takes two Arrays, a target, along with two integers p and r. 
    // p and r must be >= 0 && < the length of the Array, then 
    // returns a string with the word and line it was found on
